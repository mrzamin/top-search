...
The mission of this app is to serve people with a simple, convenient, and curated database containing links to current and relevant web development resources. It will contain the best external resources I've come across in addition to The Odin Project resources. Given the CRUD project requirements noted in the Background section [below](#Background) guests visiting the site will also be able to add resources to the database. 
